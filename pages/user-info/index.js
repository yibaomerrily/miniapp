  ...
  uploadAvatar(){
    ...
    wx.chooseImage({
      ...
      success: function(res) {
        ...
        wx.uploadFile({
          url: app.globalData.domain + '/api/fileupload/upload2',
          ...
          success: function(res) {
            ...
            if (data.code == 0) {
              ...
              let url = data.url;
              userInfo.avatarUrl =  app.globalData.domain + '/api/fileupload/getFile/' + encodeURIComponent(data.url);
              that.setData({
                userInfo: userInfo,
                url:url
              })
